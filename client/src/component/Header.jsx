        ...
        return (
            <>
                <nav className='navBar w-[100%] bg-[#076e99] text-[#fff] content-center'>
                    <div className='navContainer w-[90%] max-w-[1280px] lg:w-[90%]  h-[100px] mx-auto flex justify-between px-2 sm:px-6 lg:px-8'>
                        <div className='brandLogo w-[15%]'>
                            <Link to={'/'}><img className='w-full object-contain h-full' src={Images.carlogo} alt="" /></Link>
                        </div>

                        <div className='navList lg:flex lg:justify-around lg:w-[80%] lg:my-auto hidden'>
                            <div className='relative w-[50%] rounded-[43px] overflow-hidden '>
                        ...
                        <div className="flex relative w-[10%] items-center gap-2 sm:gap-4 lg:hidden">
                            <button
                                ref={trigger}
        ...
        <>
            <nav className='navBar navBar w-[100%] bg-[#076e99] text-[#fff] content-center'>
                <div className='navContainer w-[90%] max-w-[1280px] lg:w-[90%]  h-[100px] mx-auto flex justify-between px-2 sm:px-6 lg:px-8'>
                    ...
                    <div className='navList lg:flex lg:justify-around lg:w-[60%] lg:my-auto hidden'>
                        <div>About Us</div>
                        <Link to={'/carlist'}><div>Listings</div></Link>
                        <Link to={'/'}><div>HOME <span className='lg:inline-block hidden'><GiHomeGarage /></span></div></Link>
                        <div>AI Assistant
