...
function Admincard({ title, price, year, drivetrain, image, deletecar, edit, id }) {
    return (
        <>
            <div key={id} className='card text-[#fff] w-[300px] xl:w-[350px] mx-auto p-4 border-[2px] border-[#12232e] rounded bg-[#0b0c10] my-4'>
                <div className='imgCon '>
                    <img className='h-[190px] mx-auto object-cover' src={image} alt="" />
                </div>
