...
function Carcard({title, price, year, drivetrain, fule_type, image}) {
  return (
    <>
    <div className='card text-[#fff] w-[362px] p-4 border-[2px] border-[#12232e] rounded bg-[#0b0c10]'>
        <div className='imgCon'>
            <img className='h-[190px] w-[330px] object-cover' src={image} alt="" />
        </div>
        <div className='decCon mt-4'>
            <h3 className='text-[20px] font-[600] mb-5'>{title}</h3>
            <p className='text-[24px] font-[700] text-[#007cc7] mb-3'>${price}</p>
            <p className='font-[600] mb-3'>location</p>
            <div className='pdtDet grid grid-cols-2 border-b-2 pb-3 border-[#989898]'>
                    ...
                    <div><span className='inline-block mr-1 text-[20px] align-middle text-[#007cc7]'><MdOutlineSupervisorAccount /></span>view_seller_details</div>
            </div>
